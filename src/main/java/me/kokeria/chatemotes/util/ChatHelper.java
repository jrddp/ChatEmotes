...
public class ChatHelper {
    ...
    public static void addMsgToChat(String msg) {
        MinecraftClient.getInstance().player.addChatMessage(new LiteralText(msg), false);
    }

    public static void addMsgToChat(Text msg) {
        MinecraftClient.getInstance().player.addChatMessage(msg, false);
    }
